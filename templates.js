const templates = [
  {
    ...
    fields_vorlage: {
      ...
      stage:       { value:"", editable:true, multi:true, repeat:false, perRepeat:false, conditions:[] },
      stage_name:  { value:"", editable:false, multi:true, repeat:false, perRepeat:false,
                     conditions: [
                       { key:"stage", value:"Abbau", set:"am Abbau", mode:"equals" },
                       { key:"stage", value:"bau", set:"enthält Bau", mode:"contains" },
                       { key:"stage", value:"^Tr", set:"Regex Transport", mode:"regex" }
                     ]
                   },
